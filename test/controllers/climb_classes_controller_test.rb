...
class ClimbClassesControllerTest < ActionController::TestCase
  ...
  test "should destroy climb_class" do
    assert_difference('ClimbClass.count', -1) do
      delete :destroy, id: @climb_class
    end

    assert_redirected_to climb_classes_path
  end
end
